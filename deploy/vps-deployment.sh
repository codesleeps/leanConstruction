...
# ============================================
# VPS Deployment Script for Both Apps
# ============================================
...
# Clone repositories (update these URLs with your actual GitHub repos)
echo "📥 Cloning repositories..."
cd /var/www/lean-construction
sudo git clone https://github.com/yourusername/lean-construction.git .
cd /var/www/pixelcraft-bloom
sudo git clone https://github.com/codesleeps/pixelcraft-bloom.git .
...
echo "2. Update repository URLs in this script"
